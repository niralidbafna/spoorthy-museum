  ...
  return (
    ...
    >
      <div className="max-w-3xl">
        <p className="text-sm uppercase tracking-[0.3em] text-muted mb-6">OUR LITTLE UNIVERSE</p>
        ...
        <p className="text-xs uppercase tracking-[0.32em] text-muted mb-12">UNIVERSE NO. 001</p>
        <button
          type="button"
          onClick={onEnter}
